...
Focus: Artificial Intelligence, LLMs, Agentic Systems, Machine Learning
...
- Agentic AI Systems (LLM Agents, Tool Calling, RAG, MCP)
- Enterprise Backend Engineering (Java, Spring Boot, Microservices)
- Full-Stack Development (Java, Spring Boot, TypeScript, React, Node.js)
